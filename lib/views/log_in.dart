                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text((MainProvider().user != null && MainProvider().user!.logoName !=null && MainProvider().user!.logoName!="Empty")?MainProvider().user!.logoName.toString():"",style: TextStyle(fontSize: 24,color: ColorsOf().primaryBackGround()),)  ,),
                          Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Text((MainProvider().user != null && MainProvider().user!.addressEnterprise !=null && MainProvider().user!.addressEnterprise!="Empty")?
                                                MainProvider().user!.addressEnterprise.toString():"",
                                                  style: TextStyle(color:Color(0xFF545456) ,fontSize: 9),) ),
                                              SizedBox(height: 10,),
                                              Container(
                                                width: 200,
                                                height: 20,color: Colors.transparent,
                                                child:Text((MainProvider().user != null && MainProvider().user!.phoneEnterprise !=null && MainProvider().user!.phoneEnterprise!="Empty")?
                                                MainProvider().user!.phoneEnterprise.toString():"",
                                                  style: TextStyle(color: Color(0xFF545456) , fontSize: 8),)  ,),
